...
VarJs.fn = VarJs.prototype = {
    constructor     : VarJs,
    getRandMd5 : function(){
        return this.md5( this.config.md5 + new Date().getTime() + parseInt( Math.random() * 999999999 ) );
    },
    md5 : function( str ){
    ...
    createConfFile : function( fileString , path ){
        path = path.replace( /^[\\|\/]+/ , "" );
        grunt.file.write( path , fileString );
    },
...
module.exports = function( __grunt ){
    grunt = __grunt;
    grunt.registerMultiTask( "varJs" , "Test" , function(){
        sys = this;
        new VarJs( sys.data , 1 );
    } );    
};